...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        open_btn = Button(toolbar, image=open_icon, command=self.open_file)
        save_btn = Button(toolbar, image=save_icon, command=self.save_file)
        copy_btn = Button(toolbar, image=copy_icon, command=lambda: root.focus_get().event_generate('<<Copy>>'))
        cut_btn = Button(toolbar, image=cut_icon, command=lambda: root.focus_get().event_generate('<<Cut>>'))
        paste_btn = Button(toolbar, image=paste_icon, command=lambda: root.focus_get().event_generate('<<Paste>>'))
        bold_btn = Button(toolbar, image=bold_icon, command=self.make_bold)
        italic_btn = Button(toolbar, image=italic_icon, command=self.make_italic)
